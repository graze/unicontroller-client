...
class SerialiserVarMacro extends AbstractSerialiser implements SerialiserInterface
{
    /**
    ...
    public function serialise(EntityInterface $entity)
    {
        ...
        $properties[] = $this->stringEscaper->escape($entity->getMacroDefinition());
        $properties[] = $entity->getIsSeq();
        $properties[] = $entity->getIsRtc();
