...
class SerialiserSettingsById extends AbstractSerialiser implements SerialiserInterface
{
    /**
    ...
    {
        $properties = [];
        $properties[] = $entity->getId();
        $properties[] = $entity->getValue();
        $properties[] = $entity->getSaveToFile();
