...
use Graze\UnicontrollerClient\Entity\Entity\EntityBoxItem;

class ParserBoxItem extends AbstractParser implements ParserInterface
{
    /**
     * @return []
     */
