...
use Graze\UnicontrollerClient\Entity\Entity\EntityVarPrompt;

class ParserVarPrompt extends AbstractParser implements ParserInterface
{
    /**
     * @return []
     */
