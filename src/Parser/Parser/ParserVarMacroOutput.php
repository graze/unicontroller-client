...
use Graze\UnicontrollerClient\Entity\Entity\EntityVarMacroOutput;

class ParserVarMacroOutput extends AbstractParser implements ParserInterface
{
    /**
     * @return []
     */
    ...
    {
        return new EntityVarMacroOutput();
    }
}
