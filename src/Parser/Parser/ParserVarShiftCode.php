...
use Graze\UnicontrollerClient\Entity\Entity\EntityVarShiftCode;

class ParserVarShiftCode extends AbstractParser implements ParserInterface
{
    /**
     * @return []
     */
