...
use Graze\UnicontrollerClient\Entity\Entity\EntityVarUserId;

class ParserVarUserId extends AbstractParser implements ParserInterface
{
    /**
     * @return []
     */
